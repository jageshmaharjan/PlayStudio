...
//                        Long.parseLong(recStr[9]), Long.parseLong(recStr[10]),Boolean.parseBoolean(recStr[11]), Long.parseLong(recStr[12]),recStr[13]));
                ...
                /*
                IN HashMap form, user as key and rest are values
                * */
//                if (userBasedRecord.containsKey(recStr[0]))
//                {
//                    ArrayList<String> value = userBasedRecord.get(recStr[0]);
//                    value.add(line);
//                    userBasedRecord.put(recStr[0], value);
//                }
//                else
//                {
...
//        System.out.println("Total Monetizer Moneitised in Between '11/17/2017' and '11/23/2017' who were monetizer in '11/16/2017' : " + monitisedDateRange.size());
    ...
    private void clusteringAlgorithm(ArrayList<String> records) {

    }

    private void newGameFeature(ArrayList<String> records)
    {
        //
    }
